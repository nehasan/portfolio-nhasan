...
function setGameCanvas(){
    ...
    for(var i = 1; i < 21; i++){
        ...
        bird_image.src = '/assets/birdncrosshair/images/bird/Untitled' + i.toString() + '.png';
...
function initCrossHair(){
    ...
    crosshair.src = '/assets/birdncrosshair/images/crosshair.png';
    crosshair.width = '32';
    crosshair.height = '32';
...
function gunBang(){
    ...
    audio.src = "/assets/birdncrosshair/audio/gun_fire.mp3";
    audio.play();
